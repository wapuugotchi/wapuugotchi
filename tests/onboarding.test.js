...
test('tour is executable an complete', async ({ page }) => {
	...
	await expect(await page.locator('#wapuugotchi_onboarding__overlay .wapuugotchi_onboarding__focus').count()).toBe(1);
...
test('navigation is initiated', async ({ page }) => {
	...
	await page.waitForSelector('#wapuugotchi_onboarding__navigation .wapuugotchi_onboarding__navigation_last', { state: 'visible' });
	await page.waitForSelector('#wapuugotchi_onboarding__navigation .wapuugotchi_onboarding__navigation_play', { state: 'visible' });
	await page.waitForSelector('#wapuugotchi_onboarding__navigation .wapuugotchi_onboarding__navigation_next', { state: 'visible' });

	await expect(await page.locator('#wapuugotchi_onboarding__navigation .wapuugotchi_onboarding__navigation_stop span')).not.toHaveClass(/disabled/);
	...
	await expect(await page.locator('#wapuugotchi_onboarding__navigation .wapuugotchi_onboarding__navigation_play span')).toHaveClass(/disabled/);
...
test('step forward and backwards works', async ({ page }) => {
	...
	await page.locator('#wapuugotchi_onboarding__navigation .wapuugotchi_onboarding__navigation_next').click();
	await expect(await page.locator('#wapuugotchi_onboarding__navigation .wapuugotchi_onboarding__navigation_last span')).not.toHaveClass(/disabled/);
	await expect(await page.locator('#wapuugotchi_onboarding__navigation .wapuugotchi_onboarding__navigation_next span')).not.toHaveClass(/disabled/);

	await page.locator('#wapuugotchi_onboarding__navigation .wapuugotchi_onboarding__navigation_last').click();
	await expect(await page.locator('#wapuugotchi_onboarding__navigation .wapuugotchi_onboarding__navigation_last span')).toHaveClass(/disabled/);
	await expect(await page.locator('#wapuugotchi_onboarding__navigation .wapuugotchi_onboarding__navigation_next span')).not.toHaveClass(/disabled/);
});
