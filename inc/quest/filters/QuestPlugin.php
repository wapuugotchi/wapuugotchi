...
class QuestPlugin {
	...
	public static function add_wapuugotchi_filter( $quests ) {
		$default_quest = array(
			...
			new Quest( 'use_security_plugin_1', null, __( 'Activate a security plugin', 'wapuugotchi' ), __( 'Great!', 'wapuugotchi' ) . PHP_EOL . __( 'You\'ve installed a security plugin! This will help protecting me from villains. &#128170;', 'wapuugotchi' ), 'success', 100, 2, 'Wapuugotchi\Quest\Filters\QuestPlugin::always_true', 'Wapuugotchi\Quest\Filters\QuestPlugin::security_installed_completed_1' ),
		);
