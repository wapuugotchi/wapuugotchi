		...
		$page[] = Page::create()
		              ...
		              ->add_item(
			              Item::create()
			                  ...
			                  ->set_text( __( "In the 'Site Health' section, you can check out the overall health of your website.", 'wapuugotchi' ) )
		              ...
		              ->add_item(
			              Item::create()
			                  ...
			                  ->set_text( __( "Right off the bat, you can see how your site's performance and security are doing. Here, you can also spot any issues that need to be fixed.", 'wapuugotchi' ) )
			                  ->add_target( Target::create()->set_active( true )->set_focus( '#wpcontent' )->set_overlay( '#wpcontent' ) )
		              )
		              ->add_item(
			              Item::create()
			                  ->set_title( __( 'Report', 'wapuugotchi' ) )
			                  ->set_text( __( "If you click on the 'Report' tab, you'll get a detailed breakdown of the technical aspects of your site. Take a look if you're in the mood to be completely baffled!", 'wapuugotchi' ) )
