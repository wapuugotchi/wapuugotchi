		...
		$page[] = Page::create()
		              ...
		              ->add_item(
			              Item::create()
			                  ...
			                  ->set_text( __( "Welcome to the 'Add New User' section. Here, you can add users and manage their roles.", 'wapuugotchi' ) )
		              ...
		              ->add_item(
			              Item::create()
			                  ...
			                  ->set_text( __( "Even the 'Author' role, in the wrong hands, can cause significant damage to your site, as users with this role can write and publish posts.", 'wapuugotchi' ) )
