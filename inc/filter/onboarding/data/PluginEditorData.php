		...
		$page[] = Page::create()
		              ...
		              ->add_item(
			              Item::create()
			                  ...
			                  ->set_text( __( "This area allows you to edit the files of your plugins.", 'wapuugotchi' ) )
		              ...
		              ->add_item(
			              Item::create()
			                  ...
			                  ->set_text( __( "The same principles apply as with editing themes. In this section, you can make direct changes to the files of your plugins. You should have some programming knowledge if you're planning to work here.", 'wapuugotchi' ) )
