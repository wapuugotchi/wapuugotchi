		...
		$page[] = Page::create()
		              ...
		              ->add_item(
			              Item::create()
			                  ...
			                  ->set_text( __( "Welcome to the 'Plugins' section. Here, you can search for, install, and activate new plugins.", 'wapuugotchi' ) )
		              ...
		              ->add_item(
			              Item::create()
			                  ...
			                  ->set_text( __( "The 'Installed Plugins' section lets you manage the plugins you've already installed.", 'wapuugotchi' ) )
		              ...
		              ->add_item(
			              Item::create()
			                  ...
			                  ->set_text( __( "Plugins extend the functionality of your WordPress site. They can be things like contact forms, galleries, slideshows, SEO tools, security features, and much more.", 'wapuugotchi' ) )
		              ...
		              ->add_item(
			              Item::create()
			                  ...
			                  ->set_text( __( "There are incredibly many plugins, and you'll find that there's a plugin solution for almost every problem! Ready for the next section?", 'wapuugotchi' ) )
