		...
		$page[] = Page::create()
						...
						->add_item(
							Item::create()
								...
								->set_text( __( 'Welcome to the "Comments" section. This is where you manage the comments you receive on your site.', 'wapuugotchi' ) )
						...
						->add_item(
							Item::create()
								...
								->set_text( __( 'The "Comments" section is a key tool for engaging with your visitors. Here, you can respond to feedback and moderate discussions.', 'wapuugotchi' ) )
								->add_target( Target::create()->set_active( true )->set_focus( '#wpcontent' )->set_overlay( '#wpcontent' ) )
						)
						->add_item(
							Item::create()
								->set_title( __( 'Overview', 'wapuugotchi' ) )
								->set_text( __( 'This is where you\'ll find a list of all the comments left by visitors on your site, including the comment text, the author\'s name, the post they commented on, and the date.', 'wapuugotchi' ) )
						...
						->add_item(
							Item::create()
								...
								->set_text( __( 'The "Comment" field displays the actual content of the comment left by a visitor on your site.', 'wapuugotchi' ) )
						...
						->add_item(
							Item::create()
								...
								->set_text( __( 'The "Date" field indicates when the comment was left on your site.', 'wapuugotchi' ) )
								->add_target( Target::create()->set_active( true )->set_focus( 'td.date' )->set_overlay( 'td.date' ) )
						)
						->add_item(
							Item::create()
								->set_title( __( 'Quick Actions', 'wapuugotchi' ) )
								->set_text( __( 'Hover over a comment to see a menu. Here, you can change the comment\'s status or quickly reply to it.', 'wapuugotchi' ) )
						...
						->add_item(
							Item::create()
								...
								->set_text( __( 'A comment can be "Pending", "Approved", "Trash", or "Spam". Pending comments won\'t show on your site until you approve them.', 'wapuugotchi' ) )
						...
						->add_item(
							Item::create()
								...
								->set_text( __( 'Now you know how to control comments on your site – from approval to moderation to filtering spam – to manage visitor interaction and maintain quality discussion.', 'wapuugotchi' ) )
