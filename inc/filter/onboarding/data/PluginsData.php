		...
		$page[] = Page::create()
						...
						->add_item(
							Item::create()
								...
								->set_text( __( 'Plugins extend the functionality of your WordPress website. They can be things like contact forms, galleries, slideshows, SEO tools, security features, and much more.', 'wapuugotchi' ) )
