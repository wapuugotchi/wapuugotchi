...
class QuestContent {
	...
	public function add_wapuugotchi_filter( $quests ) {
		$default_quest = array(
			...
			new Quest( 'count_posts_3', 'count_posts_2', __( 'Create 7 posts', 'wapuugotchi' ), __( 'You created 7 posts!!', 'wapuugotchi' ), 'success', 100, 3, 'Wapuugotchi\Quest\Filters\QuestContent::always_true', 'Wapuugotchi\Quest\Filters\QuestContent::third_post_completed' ),
			new Quest( 'count_posts_4', 'count_posts_2', __( 'Create 10 posts', 'wapuugotchi' ), __( 'You created 10 posts!!', 'wapuugotchi' ), 'success', 100, 5, 'Wapuugotchi\Quest\Filters\QuestContent::always_true', 'Wapuugotchi\Quest\Filters\QuestContent::third_post_completed' ),
