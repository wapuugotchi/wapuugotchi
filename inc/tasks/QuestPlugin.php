...
class QuestPlugin {
	...
	public function add_wapuugotchi_filter( $quests ) {
		$default_quest = array(
			...
			new Quest( 'use_security_plugin_1', null, __( 'Fortress Fortification', 'wapuugotchi' ), __( 'Venture into the realm of WordPress and heed the call to fortify your digital fortress. Arm your website with a formidable security plugin to ward off virtual villains and protect your online domain from the shadows of the web. Are you ready to take on the role of the valiant protector your website deserves?', 'wapuugotchi' ), __( 'Great!', 'wapuugotchi' ) . PHP_EOL . __( 'You\'ve installed a security plugin! This will help protecting me from villains. &#128170;', 'wapuugotchi' ), 'success', 100, 2, 'Wapuugotchi\Wapuugotchi\Tasks\QuestPlugin::always_true', 'Wapuugotchi\Wapuugotchi\Tasks\QuestPlugin::security_installed_completed_1' ),
		);
