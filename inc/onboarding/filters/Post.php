		...
		$page = Guide::create()
					...
					->add_item(
						Item::create()
							...
							->set_text( __( 'The toolbar offers features to build your post step by step. Add new block elements and undo changes. Wanna see how it works? Hit ►!', 'wapuugotchi' ) )
							->set_freeze( 24000 )
