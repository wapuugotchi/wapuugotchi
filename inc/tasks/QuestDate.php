...
class QuestDate {
	...
	public function add_wapuugotchi_filter( $quests ) {
		$default_quest = array(
			new \Wapuugotchi\Wapuugotchi\Quest( 'login_1', null, __( 'Log in on 10 different days', 'wapuugotchi' ), __( 'placeholder', 'wapuugotchi' ), __( 'Nice, you logged in for 10 consecutive days!', 'wapuugotchi' ), 'success', 100, 1, 'Wapuugotchi\Wapuugotchi\QuestDate::always_true', 'Wapuugotchi\Wapuugotchi\QuestDate::login_completed_1' ),
			new \Wapuugotchi\Wapuugotchi\Quest( 'login_2', 'login_1', __( 'Log in on 20 different days', 'wapuugotchi' ), __( 'placeholder', 'wapuugotchi' ), __( 'Nice, you logged in for 20 consecutive days!', 'wapuugotchi' ), 'success', 100, 2, 'Wapuugotchi\Wapuugotchi\QuestDate::always_true', 'Wapuugotchi\Wapuugotchi\QuestDate::login_completed_2' ),
			new \Wapuugotchi\Wapuugotchi\Quest( 'login_3', 'login_2', __( 'Log in on 30 different days', 'wapuugotchi' ), __( 'placeholder', 'wapuugotchi' ), __( 'Nice, you logged in for 30 consecutive days!', 'wapuugotchi' ), 'success', 100, 3, 'Wapuugotchi\Wapuugotchi\QuestDate::always_true', 'Wapuugotchi\Wapuugotchi\QuestDate::login_completed_3' ),
			new \Wapuugotchi\Wapuugotchi\Quest( 'login_4', 'login_3', __( 'Log in on 40 different days', 'wapuugotchi' ), __( 'placeholder', 'wapuugotchi' ), __( 'Nice, you logged in for 40 consecutive days!', 'wapuugotchi' ), 'success', 100, 4, 'Wapuugotchi\Wapuugotchi\QuestDate::always_true', 'Wapuugotchi\Wapuugotchi\QuestDate::login_completed_4' ),
			new \Wapuugotchi\Wapuugotchi\Quest( 'login_5', 'login_4', __( 'Log in on 50 different days', 'wapuugotchi' ), __( 'placeholder', 'wapuugotchi' ), __( 'Nice, you logged in for 50 consecutive days!', 'wapuugotchi' ), 'success', 100, 5, 'Wapuugotchi\Wapuugotchi\QuestDate::always_true', 'Wapuugotchi\Wapuugotchi\QuestDate::login_completed_5' ),
		);
