		...
		$page[] = Page::create()
						...
						->add_item(
							Item::create()
								...
								->set_text( __( 'Welcome to the "Design" section. This is where you can manage the appearance and visual presentation of your website.', 'wapuugotchi' ) )
						...
						->add_item(
							Item::create()
								...
								->set_text( __( 'The "Themes" section lets you change the design of your website.', 'wapuugotchi' ) )
						...
						->add_item(
							Item::create()
								...
								->set_text( __( 'On the overview page, you\'ll find a list of all installed themes. Here, you can also see the active theme currently used on your site.', 'wapuugotchi' ) )
								->add_target( Target::create()->set_active( true )->set_focus( '#wpcontent' )->set_overlay( '#wpcontent' ) )
						)
						->add_item(
							Item::create()
								->set_title( __( 'Active Themes', 'wapuugotchi' ) )
								->set_text( __( 'Here, you see the active theme. This theme determines the design of your site. This is what your visitors are seeing when they visit your website right now.', 'wapuugotchi' ) )
						...
						->add_item(
							Item::create()
								...
								->set_text( __( 'There are also themes that are installed but not active. You can switch between them by activating an inactive theme, which would then change the design of your site accordingly.', 'wapuugotchi' ) )
